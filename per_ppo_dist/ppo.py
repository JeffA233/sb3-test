...
# import numpy as np
from numpy import mean as np_mean, amax, amin
# import torch as th
from torch import Tensor, device, min, clamp, abs, exp, no_grad, mean
...
from stable_baselines3.common.on_policy_algorithm_dist import OnPolicyAlgorithm
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                policy_loss = -min(advantages * ratio, advantages * clamp(ratio, 1 - clip_range, 1 + clip_range)).mean()
