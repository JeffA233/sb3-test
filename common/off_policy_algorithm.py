...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        progress_bar = tqdm.tqdm(desc=f"Learning", total=total_timesteps, leave=False, smoothing=0.01)

        while self.num_timesteps < total_timesteps:
            progress_bar.set_description(f"Collecting rollouts | steps")
            ...
            progress_bar.update(rollout.episode_timesteps)
    ...
    def collect_rollouts(
        ...
        # progress_bar = tqdm.tqdm(desc=f"Collecting rollouts", leave=False, smoothing=0.01)
