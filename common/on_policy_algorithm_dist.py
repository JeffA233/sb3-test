...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def collect_rollouts(
        ...
        with no_grad():
            # for obs in rollout_buffer.get_non_rand(self.batch_size//self.n_envs):
            #     # actions: Tensor
        ...
        rollout_buffer.compute_returns_and_advantage(last_values=values, dones=dones.astype(int).astype(float))
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            ...
            # TODO print fps, time elapsed, episode size?
